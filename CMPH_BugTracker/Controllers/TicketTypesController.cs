...
namespace CMPH_BugTracker.Controllers
{
    public class TicketTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Value")] TicketType ticketType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Value")] TicketType ticketType)
        {
            if (ModelState.IsValid)
            {
