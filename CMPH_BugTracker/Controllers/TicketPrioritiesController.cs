...
namespace CMPH_BugTracker.Controllers
{
    public class TicketPrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,TicketId,Value")] TicketPriority ticketPriority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TicketId,Value")] TicketPriority ticketPriority)
        {
            if (ModelState.IsValid)
            {
